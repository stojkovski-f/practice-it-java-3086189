...
public class MenuBuilder {
  public static void main(String[] args) {
    ...
    MenuItem starter = new MenuItem("Pickled Herring");
    ...
    MenuItem mainCourse = new MenuItem("Garlic Butter Salmon");
    ...
    MenuItem dessert = new MenuItem("Blueberry Pie w/ Vanilla Ice Cream");
